...
import { addProfileImage } from "../../stateManagement/userActions";
...
const Modal_addProfileImage = ({
  modal: { isOpen, relevantId, userProfileImageUploadProgress },
  user: {
    self: { _id: userId },
  },
  addProfileImage,
    ...
    <div className={classes.outerContainer}>
      <DialogContent classes={{ root: classes.dialogContentRoot }}>
        <FileInput
          ...
          image={image}
          setImage={setImage}
          userProfileImageUploadProgress={userProfileImageUploadProgress}
        />
      </DialogContent>
      <DialogActions>
        <Button
...
const mapStateToProps = (state, props) => ({
  modal: state.alert.addProfileImageModal,
...
const FileInput = ({
  ...
  image,
  setImage,
  userProfileImageUploadProgress,
}) => {
  ...
  return (
    <Fragment>
      {image && !userProfileImageUploadProgress && (
...
const ProgressComponent = ({ userProfileImageUploadProgress }) => {
  ...
  return (
    <div className={classes.outerContainer}>
      <CircularProgress
        variant="determinate"
        value={userProfileImageUploadProgress}
      ...
      <div className={classes.innerContainer}>
        ...
        >{`${Math.round(userProfileImageUploadProgress)}%`}</Typography>
      </div>
    </div>
  );
};
